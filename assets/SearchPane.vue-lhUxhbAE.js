const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/search-docs-data-DsG_dipy.js","assets/vendor-DviFMneE.js"])))=>i.map(i=>d[i]);
import { n as ref, k as watch, c as computed, W as markRaw, d as defineComponent, a as createElementBlock, o as openBlock, a2 as renderSlot, v as withKeys, q as normalizeClass, y as createBlock, e as unref, I as Icon, f as createVNode, b as createBaseVNode, g as createCommentVNode, z as createTextVNode, t as toDisplayString, F as Fragment, x as renderList, l as useCssVars, Z as toRefs, $ as useRouter, p as withCtx, aI as useFocus, aJ as refDebounced, w as withDirectives, ae as vModelText, a8 as withModifiers, _ as __vitePreload, aK as Fuse } from "./vendor-DviFMneE.js";
import { o as onKeyboardShortcut, u as useCommandStore } from "./bundle-main-CCXjMFtV.js";
import { u as useStoryStore } from "./story-OWVN5uic.js";
import "./mapping-CZ9N_PDo.js";
import { B as BaseEmpty } from "./BaseEmpty.vue-CWsRLboc.js";
import { _ as _export_sfc, u as useScrollOnActive, B as BaseListItemLink } from "./responsive-Ctyc-xSA.js";
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    const DocSearchData = () => __vitePreload(() => import("./search-docs-data-DsG_dipy.js"), true ? __vite__mapDeps([0,1]) : void 0);
    const props = __props;
    const emit = __emit;
    function close() {
      emit("close");
