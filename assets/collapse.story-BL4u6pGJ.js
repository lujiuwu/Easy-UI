import { ap as defineComponent, aq as createVNode, ax as Fragment, ay as useVModel, az as createTextVNode, ar as resolveComponent, as as createBlock, au as withCtx, aw as ref, at as openBlock, av as createBaseVNode, aA as createElementBlock, aB as renderList, aC as toDisplayString } from "./vendor-BgNvZzQm.js";
import { E as EyButton } from "./index-BSksiWhm.js";
...
const EyCollapse = /* @__PURE__ */ defineComponent({
  ...
  setup(props, {
    ...
    return () => {
      ...
      }, [slots.header?.() ?? createVNode(Fragment, null, [createVNode(EyButton, {
        "text": modelValue.value ? "折叠" : "展开",
        "onClick": () => {
          modelValue.value = !modelValue.value;
        }
      }, null), createVNode("span", null, [createTextVNode("Easy-UI Collapse")])])]), modelValue.value ? createVNode("div", {
        "class": "ey-collapse__content"
      }, [slots.content?.() ?? createVNode("div", null, [createVNode("p", null, [createTextVNode("Easy-UI Collapse")])])]) : null]);
    };
  }
});
