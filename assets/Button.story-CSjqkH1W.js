import { ap as defineComponent, ar as resolveComponent, as as createBlock, at as openBlock, au as withCtx, aq as createVNode, av as createBaseVNode } from "./vendor-PKX4t187.js";
...
const _hoisted_3 = { class: "flex gap-20px" };
      ...
      createVNode(_component_Variant, { title: "Variant" }, {
        default: withCtx(() => [
          createBaseVNode("div", _hoisted_1, [
            createVNode($setup["EyButton"], { variant: "default" }),
            createVNode($setup["EyButton"], { variant: "outlined" }),
            createVNode($setup["EyButton"], { variant: "text" })
          ])
        ]),
        _: 1
        /* STABLE */
